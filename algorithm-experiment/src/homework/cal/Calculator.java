...
public class Calculator extends JFrame {
    private JPanel panel1;//面板1，上面放20个按钮（5行4列）
    private JButton[] buttons1;//面板1上的按钮数组

    private JPanel panel2;//面板2，上面放4个按钮（4行1列）
    private JButton[] buttons2;//面板2上的按钮数组

    private JPanel panel3;//面板3，上面放2个按钮（1行2列）
    private JButton[] buttons3;//面板3上的按钮数组

    private JPanel panel4;//面板4，上面放1个按钮（1行1列）
    private JButton button4;

    private JPanel panel5;//面板5，上面放1个按钮（1行1列）
    private JButton button5;

    private JPanel radioBtnPanel; //单选框

    private JPanel optionPanel; //左侧复杂操作面板
